...
import com.chrrissoft.marvel.ui.data.chars.res.CharsPrevRes as UICharsPrevRes
...
import com.chrrissoft.marvel.ui.data.chars.res.CharsPrevResState.Error as UiError
import com.chrrissoft.marvel.ui.data.chars.res.CharsPrevResState.Success as UiSuccess
import com.chrrissoft.marvel.ui.data.chars.res.CharsPrevResState.Loading as UiLoading
...
fun charsPrevConverter(res: CharsPrevRes): UICharsPrevRes {
    return when (res.state) {
        ...
        is DataError -> UICharsPrevRes(UiError(res.state.message, res.state.data.map { it.toUi() }))
    }
}